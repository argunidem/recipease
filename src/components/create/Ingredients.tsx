  ...
  return (
    <div className='flex w-full flex-col justify-center space-y-0.5'>
      <div className='flex w-full flex-col justify-center space-y-0.5 xs:space-y-0 xs:flex-row'>
        <span className='bg-base-100 flex items-center justify-center rounded-md xs:w-1/4 xs:rounded-r-none xs:border-r xs:border-r-white'>
          {count}
        </span>
        <input
          type='text'
          ...
          className='xs:w-3/4 xs:rounded-l-none focus:bg-recipease-400'
        />
      </div>
      <button
        onClick={(e) => onclick()}
